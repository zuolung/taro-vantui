...
const Picker = class {
  constructor(hostRef) {
    ...
    this.onColumnChange = index.createEvent(this, "columnchange", 7);
    this.onCancel = index.createEvent(this, "cancel", 7);
    this.index = [];
    this.mode = 'selector';
    this.disabled = false;
    this.range = [];
    ...
    // 单列选择器
    this.getSelector = () => {
      return (index.h("taro-picker-group", { range: this.range, rangeKey: this.rangeKey, height: this.height[0], updateHeight: this.updateHeight, columnId: '0' }));
    };
    // 多列选择器
    this.getMultiSelector = () => {
      return this.range.map((range, index$1) => {
        return (index.h("taro-picker-group", { range: range, rangeKey: this.rangeKey, height: this.height[index$1], updateHeight: this.updateHeight, onColumnChange: this.handleColumnChange, columnId: String(index$1) }));
      });
    };
    // 时间选择器
    this.getTimeSelector = () => {
      ...
      return [
        index.h("taro-picker-group", { mode: 'time', range: hourRange, height: this.height[0], updateHeight: this.updateHeight, columnId: '0' }),
        index.h("taro-picker-group", { mode: 'time', range: minRange, height: this.height[1], updateHeight: this.updateHeight, columnId: '1' })
      ];
    };
    // 日期选择器
    this.getDateSelector = () => {
      ...
      const renderView = [
        index.h("taro-picker-group", { mode: 'date', range: yearRange, height: height[0], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '0' })
      ];
      if (fields === 'month' || fields === 'day') {
        renderView.push(index.h("taro-picker-group", { mode: 'date', range: monthRange, height: height[1], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '1' }));
      }
      if (fields === 'day') {
        renderView.push(index.h("taro-picker-group", { mode: 'date', range: dayRange, height: height[2], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '2' }));
      }
      return renderView;
    };
  }
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { onClick: this.showPicker }, index.h("slot", null), index.h("input", { type: 'hidden', name: name, value: formatValue(this.pickerValue) })), index.h("div", { class: 'weui-picker__overlay', style: shouldDivHidden, ref: el => { this.overlay = el; } }, index.h("div", { class: clsMask, onClick: this.handleCancel }), index.h("div", { class: clsSlider }, index.h("div", { class: 'weui-picker__hd' }, index.h("div", { class: 'weui-picker__action', onClick: this.handleCancel }, "\u53D6\u6D88"), index.h("div", { class: 'weui-picker__action', onClick: this.handleChange }, "\u786E\u5B9A")), index.h("div", { class: 'weui-picker__bd' }, pickerGroup), index.h("input", { type: 'hidden', name: name, value: formatValue(this.pickerValue) })))));
  }
...
const TaroPickerGroup = class {
  ...
  render() {
    ...
    const pickerItem = range.map(item => {
      ...
      return (index.h("div", { class: 'weui-picker__item' }, content));
    });
    return (index.h(index.Host, { class: 'weui-picker__group' }, index.h("div", { class: 'weui-picker__mask' }), index.h("div", { class: 'weui-picker__indicator' }), index.h("div", { class: 'weui-picker__content', style: this.getPosition() }, pickerItem)));
  }
};
