...
import { Skeleton, Switch, Image } from 'taro-vantui'
    ...
    return (
      <Block>
        <DemoBlock title="基础用法">
          <Skeleton title row="3" rowWidth={['100%', '100%', '80%']}></Skeleton>
        </DemoBlock>
        <DemoBlock title="显示头像">
          <Skeleton title avatar row="3"></Skeleton>
        </DemoBlock>
        <DemoBlock title="展示子组件">
          <Switch checked={show} size="24px" onChange={this.onChange}></Switch>
