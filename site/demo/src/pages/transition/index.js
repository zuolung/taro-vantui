...
import { Transition, Cell } from 'taro-vantui'
  ...
  render() {
    ...
    return (
      <DemoBlock title="基础用法" padding>
        ...
        <Cell title="Fade Right" onClick={this.onClickFadeRight} isLink></Cell>
        <Cell title="Slide Up" onClick={this.onClickSlideUp} isLink></Cell>
        <Cell title="Slide Down" onClick={this.onClickSlideDown} isLink></Cell>
        <Cell title="Slide Left" onClick={this.onClickSlideLeft} isLink></Cell>
        <Cell
          title="Slide Right"
