import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-310de3d5.js';
...
const Video = class {
  ...
  render() {
    ...
    return (h(Host, { class: classnames('taro-video-container', {
      ...
      }, controls: controls, currentTime: this.currentTime, duration: this.duration || this._duration || undefined, isPlaying: this.isPlaying, pauseFunc: this._pause, playFunc: this._play, seekFunc: this._seek, showPlayBtn: this.showPlayBtn, showProgress: this.showProgress }, showMuteBtn && (h("div", { class: classnames('taro-video-mute', {
