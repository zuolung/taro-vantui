...
const VideoControl = class {
  ...
  render() {
    ...
    if (!showPlayBtn) {
      ...
      playBtn = index.h("div", { class: 'taro-video-control-button taro-video-control-button-pause', onClick: pauseFunc });
    }
    else {
  ...
  get controlsRef() { return index.getElement(this); }
};
...
const Video = class {
  constructor(hostRef) {
    ...
    this.onFullScreenChange = index.createEvent(this, "fullscreenchange", 7);
    this.onProgress = index.createEvent(this, "progress", 7);
    this.onLoadedMetaData = index.createEvent(this, "loadedmetadata", 7);
    this.currentTime = 0;
  ...
  render() {
    ...
    return (index.h(index.Host, { class: index$1.classnames('taro-video-container', {
      ...
      }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (index.h("div", { class: 'taro-video-cover' }, index.h("div", { class: 'taro-video-cover-play-button', onClick: () => this.play() }), index.h("p", { class: 'taro-video-cover-duration' }, durationTime))), index.h("taro-video-control", { ref: dom => {
        if (dom) {
          this.controlsRef = dom;
        }
      }, controls: controls, currentTime: this.currentTime, duration: this.duration || this._duration || undefined, isPlaying: this.isPlaying, pauseFunc: this._pause, playFunc: this._play, seekFunc: this._seek, showPlayBtn: this.showPlayBtn, showProgress: this.showProgress }, showMuteBtn && (index.h("div", { class: index$1.classnames('taro-video-mute', {
        'taro-video-type-mute': isMute
      }), onClick: this.toggleMute })), danmuBtn && (index.h("div", { class: index$1.classnames('taro-video-danmu-button', {
        'taro-video-danmu-button-active': _enableDanmu
      }), onClick: this.toggleDanmu }, "\u5F39\u5E55")), showFullscreenBtn && (index.h("div", { class: index$1.classnames('taro-video-fullscreen', {
        'taro-video-type-fullscreen': isFullScreen
      ...
      } }, index.h("div", { class: 'taro-video-toast-title' }, "\u97F3\u91CF"), index.h("div", { class: 'taro-video-toast-icon' }), index.h("div", { class: 'taro-video-toast-value' }, index.h("div", { class: 'taro-video-toast-value-content', ref: dom => {
        if (dom) {
          this.toastVolumeBarRef = dom;
        }
      } }, index.h("div", { class: 'taro-video-toast-volume-grids' }, Array(10).fill(1).map(() => (index.h("div", { class: 'taro-video-toast-volume-grids-item' }))))))), index.h("div", { class: 'taro-video-toast taro-video-toast-progress', ref: dom => {
        if (dom) {
          this.toastProgressRef = dom;
        }
      } }, index.h("div", { class: 'taro-video-toast-title', ref: dom => {
        if (dom) {
...
const VideoDanmu = class {
  ...
  render() {
    if (!this.enable)
      return '';
    return (index.h(index.Host, { class: 'taro-video-danmu' }, this.danmuList.map(({ text, color, bottom, key }) => (index.h("p", { class: 'taro-video-danmu-item', key: key, style: {
        color,
        bottom
      }, ref: ref => {
        if (ref) {
...
exports.taro_video_control = VideoControl;
exports.taro_video_core = Video;
exports.taro_video_danmu = VideoDanmu;
