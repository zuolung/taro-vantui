...
var UniversalRouter = function () {
  function UniversalRouter(routes, options) {
    ...
    if (!routes || _typeof$1(routes) !== 'object') {
...
function findDOM(inst) {
  ...
  if (inst) {
    var find = runtimeHooks.getDOMNode;
...
function getParameterError(_ref) {
  ...
  var errorType = upperCaseFirstLetter(wrong === null ? 'Null' : _typeof$1(wrong));
...
function serializeParams(params) {
  ...
  return Object.keys(params).map(function (key) {
    return "".concat(encodeURIComponent(key), "=").concat(_typeof$1(params[key]) === 'object' ? encodeURIComponent(JSON.stringify(params[key])) : encodeURIComponent(params[key]));
  }).join('&');
}
...
var Behavior$1 = Taro.Behavior,
    ...
    useTitleClick = Taro.useTitleClick,
    useOptionMenuClick = Taro.useOptionMenuClick,
    usePullIntercept = Taro.usePullIntercept,
    useShareTimeline = Taro.useShareTimeline,
    useAddToFavorites = Taro.useAddToFavorites,
    useReady = Taro.useReady,
...
var initPxTransform = getInitPxTransform$1(taro);
...
var createCanvasContext = function createCanvasContext(canvasId, inst) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reserve = _args.length > 0 && _args[0] !== undefined ? _args[0] : false;
            ...
            case 7:
              ...
              _step$value = _step.value, func = _step$value.func, args = _step$value.args;
              _context.next = 11;
  ...
  ['setTextBaseline', function (textBaseline) {
    ...
    if (typeof url === 'string') {
      ...
      return new Promise(function (resolve, reject) {
        img.onload = function () {
          ctx.drawImage.apply(ctx, [img].concat(extra));
          resolve();
        };
    ...
    ctx.drawImage.apply(ctx, [url].concat(extra));
  }]];
  var functionProperties = [['arc'], ['arcTo'], ['beginPath'], ['bezierCurveTo'], ['clearRect'], ['clip'], ['closePath'], ['createLinearGradient', true], ['createPattern', true], ['fill'], ['fillRect'], ['fillText'], ['lineTo'], ['measureText', true], ['moveTo'], ['quadraticCurveTo'], ['rect'], ['restore'], ['rotate'], ['save'], ['scale'], ['setTransform'], ['stroke'], ['strokeRect'], ['strokeText'], ['transform'], ['translate']];
  var valueProperties = [['fillStyle'], ['font', true], ['globalAlpha'], ['lineCap'], ['lineDashOffset'], ['lineJoin'], ['lineWidth'], ['miterLimit'], ['shadowOffsetX'], ['shadowOffsetY'], ['shadowColor'], ['shadowBlur'], ['strokeStyle'], ['textAlign', true], ['textBaseline', true], ['direction', true], ['globalCompositeOperation'], ['imageSmoothingEnabled '], ['imageSmoothingQuality'], ['filter']];
  var CanvasContext = {
    __raw__: ctx
  };
  customProperties.forEach(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 3),
        funcName = _ref3[0],
        func = _ref3[1],
        setImmediatly = _ref3[2];

    Object.defineProperty(CanvasContext, funcName, {
      get: function get() {
        var fn = enqueueActions(func);
        return function () {
  ...
  valueProperties.forEach(function (_ref6) {
    var _ref7 = _slicedToArray(_ref6, 2),
        propertyName = _ref7[0],
        setImmediatly = _ref7[1];
...
function getItem(key) {
  ...
  if (item && _typeof$1(item) === 'object' && item.hasOwnProperty('data')) {
    return {
      result: true,
      data: item.data
    };
...
var StyleSheet = function StyleSheet() {
  ...
  _defineProperty$1(this, "$style", null);

  _defineProperty$1(this, "sheet", null);

  _defineProperty$1(this, "appendStyleSheet", function () {
  ...
  _defineProperty$1(this, "add", function (cssText) {
...
var Animation = /*#__PURE__*/function () {
  function Animation() {
    ...
    _defineProperty$1(this, "rules", []);

    _defineProperty$1(this, "transform", ["".concat(TRANSFORM, ":")]);

    _defineProperty$1(this, "steps", []);

    _defineProperty$1(this, "animationMap", {});

    _defineProperty$1(this, "animationMapCount", 0);
...
function filter(fields, dom, selector) {
  ...
  if (computedStyle.length) {
    ...
    computedStyle.forEach(function (key) {
      var value = styles.getPropertyValue(key) || styles[key];
...
var NodesRef = /*#__PURE__*/function () {
  function NodesRef(selector, querySelectorQuery, single) {
    _classCallCheck$1(this, NodesRef);
...
var createUploadTask = function createUploadTask(_ref) {
  ...
  var send = function send() {
    xhr.send(form);
    timeoutInter = setTimeout(function () {
      xhr.onabort = null;
      xhr.onload = null;
...
var Toast = /*#__PURE__*/function () {
  ...
  _createClass$1(Toast, [{
    ...
    value: function create() {
      ...
      var config = _objectSpread2(_objectSpread2({}, this.options), options); // wrapper
      ...
      if (config.image) {
        this.icon.setAttribute('style', inlineStyle(_objectSpread2(_objectSpread2({}, imageStyle), {}, {
          'background-image': "url(".concat(config.image, ")")
        })));
      } else {
        var iconStyle = config.icon === 'loading' ? loadingStyle : successStyle;
        this.icon.setAttribute('style', inlineStyle(_objectSpread2(_objectSpread2({}, iconStyle), config.icon === 'none' ? {
          display: 'none'
        } : {})));
      ...
      this.toast.setAttribute('style', inlineStyle(_objectSpread2(_objectSpread2({}, toastStyle), config.icon === 'none' ? {
        'min-height': '0',
        padding: '10px 15px'
      } : {}))); // title
    ...
    value: function show() {
      ...
      var config = _objectSpread2(_objectSpread2({}, this.options), options);
...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass$1(Modal, [{
    ...
    value: function create() {
      ...
      var titleCSS = config.title ? titleStyle : _objectSpread2(_objectSpread2({}, titleStyle), {}, {
        display: 'none'
      });
      ...
      var textCSS = config.title ? textStyle : _objectSpread2(_objectSpread2({}, textStyle), {}, {
      ...
      var cancelCSS = _objectSpread2(_objectSpread2({}, btnStyle), {}, {
    ...
    value: function show() {
      ...
      if (config.title) {
        ...
        var textCSS = _objectSpread2(_objectSpread2({}, textStyle), {}, {
          padding: '40px 20px 26px',
          color: '#353535'
        });
...
var ActionSheet = /*#__PURE__*/function () {
  function ActionSheet() {
    _classCallCheck$1(this, ActionSheet);
    ...
    _defineProperty$1(this, "lastConfig", {});
  }

  _createClass$1(ActionSheet, [{
    key: "create",
    value: function create() {
      var _this = this;
      ...
      this.menu.setAttribute('style', inlineStyle(_objectSpread2(_objectSpread2({}, menuStyle), {}, {
...
function createLocaltionChooser(handler) {
  ...
  var main = container.querySelector('.taro_chooselocation');
...
var chooseLocation = function chooseLocation() {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var chooser = createLocaltionChooser(function (res) {
      if (res) {
        onError(res);
      } else {
...
var canUsePromise = function () {
  return 'Promise' in win && _typeof$2(isFunction$1(Promise));
}();
...
function jsonp$1(url, opts, cb) {
  if (isFunction$1(url)) {
    cb = url;
    opts = {};
  } else if (url && (typeof url === 'undefined' ? 'undefined' : _typeof$2(url)) === 'object') {
    cb = opts;
    opts = url || {};
    url = opts.url;
  }
...
function _request(options) {
  ...
  if (methodUpper === 'GET' || methodUpper === 'HEAD') {
  ...
  } else if (_typeof$1(options.data) === 'object') {
    options.header = options.header || {};
    var keyOfContentType = Object.keys(options.header).find(function (item) {
    ...
    var contentType = options.header[keyOfContentType || 'Content-Type'];
...
var link = new Link$2(taroInterceptor);
/** @type {TaroH5.request} */
...
function createVideoContext(id, inst) {
  /** @type {HTMLVideoElement} */
  return findDOM(inst).querySelector("taro-video-core[id=".concat(id, "]"));
}

var SocketTask = /*#__PURE__*/function () {
  function SocketTask(url, protocols) {
    _classCallCheck$1(this, SocketTask);
  ...
  _createClass$1(SocketTask, [{
    ...
    value: function send() {
      ...
      if (_typeof$1(obj) !== 'object' || !obj) obj = {};
      var _obj = obj,
          _obj$data = _obj.data,
