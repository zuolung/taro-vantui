...
const getCopyWebpackPlugin = ({ copy, appPath }) => {
    const args = [
        copy.patterns.map((_a) => {
            ...
            return Object.assign({ from, to: path_1.resolve(appPath, to), context: appPath }, extra);
        }),
        copy.options
    ];
...
const getFastRefreshPlugin = () => {
    return lodash_1.partial(getPlugin, ReactRefreshWebpackPlugin)([]);
};
exports.getFastRefreshPlugin = getFastRefreshPlugin;
...
const getModule = (appPath, { staticDirectory, designWidth, deviceRatio, enableExtract, enableSourceMap, styleLoaderOption, cssLoaderOption, lessLoaderOption, sassLoaderOption, stylusLoaderOption, fontUrlLoaderOption, imageUrlLoaderOption, mediaUrlLoaderOption, esnextModules = [], postcss }) => {
