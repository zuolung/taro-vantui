...
function default_1(appPath, config) {
    ...
    if (config.framework === helper_1.FRAMEWORK_MAP.REACT && ((_a = config.devServer) === null || _a === void 0 ? void 0 : _a.hot) !== false) {
        // 默认开启 fast-refresh
        plugin.fastRefreshPlugin = chain_1.getFastRefreshPlugin();
    }
    const mode = 'development';
    if (config.framework === helper_1.FRAMEWORK_MAP.REACT || config.framework === helper_1.FRAMEWORK_MAP.NERV) {
        if (useHtmlComponents && config.framework === helper_1.FRAMEWORK_MAP.REACT) {
