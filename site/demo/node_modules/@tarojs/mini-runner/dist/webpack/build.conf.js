...
exports.default = (appPath, mode, config) => {
    ...
    const runtimeConstants = chain_1.getRuntimeConstants(runtime);
    const constantsReplaceList = chain_1.mergeOption([chain_1.processEnvOption(env), defineConstants, runtimeConstants]);
    ...
    if (optimizeMainPackage.enable) {
        plugin.miniSplitChunksPlugin = chain_1.getMiniSplitChunksPlugin({
    ...
    plugin.miniPlugin = !isBuildNativeComp ? chain_1.getMiniPlugin(miniPluginOptions) : chain_1.getBuildNativePlugin(miniPluginOptions);
