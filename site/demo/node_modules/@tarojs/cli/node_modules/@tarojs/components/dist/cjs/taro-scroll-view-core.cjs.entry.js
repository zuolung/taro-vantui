...
const ScrollView = class {
  constructor(hostRef) {
    ...
    this.onScroll = index.createEvent(this, "scroll", 7);
    this.onScrollToUpper = index.createEvent(this, "scrolltoupper", 7);
    this.onScrollToLower = index.createEvent(this, "scrolltolower", 7);
    this.scrollX = false;
    this.scrollY = false;
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cls, onScroll: this.handleScroll }, index.h("slot", null)));
  }
