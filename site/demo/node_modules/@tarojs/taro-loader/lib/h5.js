...
function default_1() {
    ...
    const { importFrameworkStatement, frameworkArgs, creator, importFrameworkName, extraImportForWeb, execBeforeCreateWebApp, compatComponentImport, compatComponentExtra } = utils_1.frameworkMeta[options.framework];
