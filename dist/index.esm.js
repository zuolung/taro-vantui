...
import require$$0, { useState, useEffect, useRef, useCallback, isValidElement, cloneElement, useMemo, forwardRef, useImperativeHandle, memo, useLayoutEffect } from 'react';
import Taro, { usePageScroll as usePageScroll$1, Events } from '@tarojs/taro';
import { View, Image, Block, Button, ScrollView, Text, Navigator, Canvas, CoverView, Textarea, Input, Video } from '@tarojs/components';
/*! *****************************************************************************
...
function Index$15(props) {
  ...
  var _useState = useState(_Array$from({
    length: 12
  })),
...
function Index$14(props) {
  var _props$type = props.type,
      ...
      loadingSize = _props$loadingSize === void 0 ? Taro.pxTransform(40) : _props$loadingSize,
  ...
  return jsxRuntime.exports.jsx(Button, _Object$assign({
    ...
    children: loading ? jsxRuntime.exports.jsxs(Block, {
      ...
      }, void 0), loadingText && jsxRuntime.exports.jsx(View, _Object$assign({
...
function Index$_(props) {
  ...
  var setNextHeight = useCallback(function () {
    ...
    children: [fixed && placeholder && jsxRuntime.exports.jsx(View, {
      ...
      children: jsxRuntime.exports.jsxs(View, _Object$assign({
        ...
        children: [jsxRuntime.exports.jsx(View, _Object$assign({
          ...
          children: leftArrow || leftText ? jsxRuntime.exports.jsxs(Block, {
            children: [leftArrow && jsxRuntime.exports.jsx(Index$16, {
              size: 64,
              name: "arrow-left",
              className: "van-nav-bar__arrow"
            }, void 0), leftText && jsxRuntime.exports.jsx(View, _Object$assign({
          ...
          children: rightText ? jsxRuntime.exports.jsx(View, _Object$assign({
            className: "van-nav-bar__text",
            hoverClass: "van-nav-bar__text--hover",
            hoverStayTime: 70
          }, {
...
function Index$T(props) {
  var src = props.src,
      ...
      others = __rest(props, ["src", "round", "width", "height", "radius", "lazyLoad", "useErrorSlot", "useLoadingSlot", "showMenuByLongpress", "fit", "showError", "showLoading", "className", "style", "renderError", "renderLoading"]);
  ...
  return jsxRuntime.exports.jsxs(View, _Object$assign({
    ...
    children: [!error && jsxRuntime.exports.jsx(Image, {
      ...
      children: useLoadingSlot ? renderLoading : jsxRuntime.exports.jsx(Index$16, {
        name: "photo",
      ...
      children: useErrorSlot ? renderError : jsxRuntime.exports.jsx(Index$16, {
        name: "photo-fail",
  ...
  return jsxRuntime.exports.jsxs(View, _Object$assign({
    ...
    children: [icon ? jsxRuntime.exports.jsx(Index$16, {
      ...
      children: [title || title === 0 ? jsxRuntime.exports.jsx(Block, {
        children: title
      }, void 0) : renderTitle, (label || useLabelSlot) && jsxRuntime.exports.jsx(View, _Object$assign({
        className: "van-cell__label label-class"
      }, {
        children: useLabelSlot ? renderLabel : label && jsxRuntime.exports.jsx(Block, {
          children: label
        }, void 0)
      }), void 0)]
    }), void 0), jsxRuntime.exports.jsx(View, _Object$assign({
...
function Index$J(props) {
  ...
  var getContext = useCallback(function () {
    if (type === '' || !canIUseCanvas2d()) {
      var ctx = Taro.createCanvasContext('van-circle');
      return _Promise.resolve(ctx);
    }

    var dpr = getSystemInfoSync().pixelRatio;
    return new _Promise(function (resolve) {
      Taro.createSelectorQuery().select('#van-circle').node().exec(function (res) {
  ...
  var setHoverColor = useCallback(function () {
    if (isObj$1(color)) {
      var _color = color;
  ...
  var clearMockInterval = useCallback(function () {
...
function Index$B(props) {
  var _useState55 = useState(_Array$from({
    length: 5
  })),
...
function Index$z(props) {
  ...
  return jsxRuntime.exports.jsxs(View, _Object$assign({
    ...
    }), void 0), (showAction || useActionSlot) && jsxRuntime.exports.jsx(View, _Object$assign({
      className: "van-search__action",
      hoverClass: "van-search__action--hover",
      hoverStayTime: 70
    }, {
      children: useActionSlot ? renderAction : jsxRuntime.exports.jsx(View, _Object$assign({
        onClick: _cancel,
...
var index$3 = /*#__PURE__*/forwardRef(Index$w); // import Button from './../button'
...
function Index$r(props) {
  ...
  var _onChange = useCallback(function () {
  ...
  var _longPressStep = useCallback(function () {
...
function Index$l(props) {
  ...
  return jsxRuntime.exports.jsx(View, _Object$assign({
    ...
    children: jsxRuntime.exports.jsx(View, _Object$assign({
      ...
      children: useSlot ? jsxRuntime.exports.jsx(Block, {
...
function Index$f(props) {
  ...
  var onClick = useCallback(function (event) {
    if (disabled) return;
    getRect(null, ".van-slider".concat(currentIndex_, " ")).then(function (rect) {
      var value = (event.clientX - rect.left) / rect.width * getRange() + min;
  ...
  return jsxRuntime.exports.jsx(View, _Object$assign({
    ...
    children: jsxRuntime.exports.jsxs(View, _Object$assign({
      ...
      children: [range && jsxRuntime.exports.jsx(View, _Object$assign({
        ...
        children: useButtonSlot ? renderLeftbutton ? renderLeftbutton(value_) : '' : jsxRuntime.exports.jsx(View, {
        ...
        children: useButtonSlot ? renderRightbutton ? renderRightbutton(value_) : '' : jsxRuntime.exports.jsx(View, {
          className: bem('slider__button')
        }, void 0)
      }), void 0), !range && jsxRuntime.exports.jsx(View, _Object$assign({
        ...
        children: useButtonSlot && renderButton ? renderButton : jsxRuntime.exports.jsx(View, {
          className: bem('slider__button')
        }, void 0)
      }), void 0)]
    }), void 0)
...
function Index$a(props) {
  ...
  var _onSelect = useCallback(function (option) {
    onSelect === null || onSelect === void 0 ? void 0 : onSelect({
      detail: option
    });
  }, [onSelect]);
  ...
  return jsxRuntime.exports.jsxs(Index$W, _Object$assign({
    ...
    children: [jsxRuntime.exports.jsxs(View, _Object$assign({
      ...
      options: options,
      onSelect: _onSelect
    }, void 0), jsxRuntime.exports.jsx(Button, _Object$assign({
...
function Index$9(props) {
  ...
  var _onClickNav = useCallback(function (index) {
...
function Index$3(props, ref) {
  ...
  var onConfirm_ = useCallback(function () {
...
export { Index$v as ActionSheet, index$2 as Area, Index$14 as Button, index as Calendar, Index as Card, Index$L as Cell, Index$A as CellGroup, Index$I as Checkbox, Index$H as CheckboxGroup, Index$J as Circle, Index$S as Col, Index$M as Collapse, Index$K as CollapseItem, Index$2 as ConfigProvider, index$3 as CountDown, Index$c as DatetimePicker, Index$7 as Dialog, Index$O as Divider, Index$j as DropdownItem, Index$k as DropdownMenu, Index$P as Empty, Index$G as Field, Index$i as GoodsAction, Index$h as GoodsActionButton, Index$g as GoodsActionIcon, Index$m as Grid, Index$l as GridItem, Index$16 as Icon, Index$T as Image, Index$u as IndexAnchor, Index$t as IndexBar, Index$17 as Info, Index$15 as Loading, Index$13 as MiniLoginButton, Index$Z as MiniNavBar, Index$12 as MiniPhoneButton, Index$11 as MiniUserButton, Index$_ as NavBar, Index$N as NoticeBar, Index$n as Notify, Index$X as Overlay, VanPicker as Picker, Index$W as Popup, Index$10 as Progress, Index$F as Radio, Index$E as RadioGroup, Index$B as Rate, Index$R as Row, Index$z as Search, Index$a as ShareSheet, Index$e as Sidebar, Index$d as SidebarItem, Index$y as Skeleton, Index$f as Slider, Index$r as Stepper, Index$q as Steps, Index$$ as Sticky, Index$1 as SubmitBar, index$1 as SwipeCell, Index$D as Switch, Index$U as Tab, Index$p as Tabbar, Index$o as TabbarItem, Index$V as Tabs, Index$x as Tag, Index$Q as Toast, Index$Y as Transition, Index$9 as TreeSelect, Index$C as Uploader, dialog, Notify as notify, Toast as toast };
